    ...
    return (
      <Paper className = "home" elevation = {20}>
        ...
        <div className = "text">
          ...
          <br/>
          <h1>This website contains color design reference, Material-UI component demos, char demos generated by React-vis, and icon library. Each demo comes with sample code usage. Click left meun to check details. Right menu directs to exteral reference websites</h1>
          <br/>
