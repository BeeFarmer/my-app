  ...
  render() {
    return (
      <Paper className = "home" elevation = {20}>
        ...
        <br/>
        <div className = "text">
          <h1>This is my personal Material-UI and React design reference website, build by React-Redux and Material-UI. </h1>
          <br/>
          <h1>This website includes color design reference, Material-UI component demos, char demos generated by React-vis, and a icon library. Each demo comes with sample code usage. Click left meun to check details. Right menu directs to exteral reference websites.</h1>
          <br/>
